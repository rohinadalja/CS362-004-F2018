...
int playAdventurerCard(struct gameState *state, int currentPlayer, int *temphand)
{
...
int playCouncilRoomCard(struct gameState *state, int currentPlayer, int handPos)
{
  int i = 0;
...
int playVillageCard(struct gameState *state, int currentPlayer, int handPos)
{
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return playAdventurerCard(state, currentPlayer, temphand);
      
    case council_room:
      return playCouncilRoomCard(state, currentPlayer, handPos);
      
    case feast:
      return playFeastCard(state, currentPlayer, choice1, temphand);
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
  {
    ...
    case smithy:
      return playSmithyCard(state, currentPlayer, handPos);
    
    case village:
      return playVillageCard(state, currentPlayer, handPos);
